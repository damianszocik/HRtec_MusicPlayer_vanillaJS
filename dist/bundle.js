...
var _songs = __webpack_require__(/*! ./songs */ "./src/songs.js");

var songs = _interopRequireWildcard(_songs);

__webpack_require__(/*! ./scrollbar */ "./src/scrollbar.js");

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

//play-pause button toggle
var playPauseButton = document.querySelector(".play-pause-button__button");
...
var playlistToggle = function playlistToggle() {
...
var ps = new _perfectScrollbar2.default(".playlist__content", {
...
var generateSongDuration = function generateSongDuration() {
    var minutes = Math.floor(Math.random() * (5 - 2 + 1)) + 2;
    var seconds = Math.floor(Math.random() * (59 - 0 + 1)) + 0;
    return minutes + ":" + (seconds < 10 ? "0" + seconds : seconds);
};

var songsList = exports.songsList = [{
    artist: "Icona Pop",
...
var injectSongsToPlaylist = exports.injectSongsToPlaylist = function injectSongsToPlaylist() {
    var targetContianer = document.querySelector(".playlist__content");
...
var playlistContent = document.querySelector(".playlist__content");
...
var previousButton = document.querySelector(".button__previous");
var switchSong = function switchSong(direction) {
    var currentSong = document.querySelector("#player-title");
    var currentSongTitle = currentSong.innerHTML;
    songsList.forEach(function (song, index, arr) {
